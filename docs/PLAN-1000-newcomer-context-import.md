...
4. **证据来源**：`%USERPROFILE%\Downloads\Link16-安装记录.zip`（3050 机器 2026-09-08 完整 429 条对话 + 结构化档案）；本仓代码定位见 §1 各 Step 括号里的文件行号；Claude 桌面版数据落点来自 claude.com 官方 data-storage 文档与两篇逆向文章。
