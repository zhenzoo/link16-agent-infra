...
|---|---:|---:|---:|---|---|
| TB24（全量复核） | 137 | 465 | **90.6 万字** | 7 / 21 | xhs-autopilot 53.2 万 · voiceover 29.1 万 · tennis-post 7.1 万 |
| TB25（自报·**下界**） | 481 | 882 | **391.5 万字** | 17 / 29 | phd-taoci 一队 8 只占 **99%**（单只最高 109.4 万字） |

- 两机合计 **≥ 618 次发作 / ≥ 482 万字重发正文**，最早 07-13。TB25 那一列是**下界**：它跑的是本工具首版（尾部截断·见下），GB 级 outbox 可能少算，待全量重跑更正。
